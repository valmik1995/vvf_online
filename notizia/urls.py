...
urlpatterns = [
    ...
    path('list/<slug:comune>', NotiziaListViewComune.as_view(), name='notizia_list_comune'),
    path('list/elenco/<slug:provincia>', NotiziaListViewProvincia.as_view(), name='notizia_list_provincia'),
